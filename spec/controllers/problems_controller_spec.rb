...
RSpec.describe ProblemsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new problem" do
        ...
        expect(response.location).to eq(problem_url(Problem.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new problem" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the problem" do
        problem = Problem.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the problem" do
        problem = Problem.create! valid_attributes
